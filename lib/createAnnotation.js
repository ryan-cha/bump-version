...
function createAnnotations({ githubToken, newVersion, linesReplaced = [], }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            //   }
            // );
            console.log("annotation params = ", JSON.stringify(Object.assign(Object.assign({}, github.context.repo), { name: "bump-version", head_sha: getSha(github.context), conclusion: "success", output: {
