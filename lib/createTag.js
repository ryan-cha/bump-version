...
function createTag({ GITHUB_TOKEN, tagName, tagMsg = "" }) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const tags = yield git.repos.listTags(Object.assign(Object.assign({}, github.context.repo), { per_page: 100 }));
        ...
        try {
            const newTag = yield git.git.createTag(Object.assign(Object.assign({}, github.context.repo), { tag: tagName, message: tagMsg, object: process.env.GITHUB_SHA, type: "commit" }));
            const newReference = yield git.git.createRef(Object.assign(Object.assign({}, github.context.repo), { ref: `refs/tags/${newTag.data.tag}`, sha: newTag.data.sha }));
